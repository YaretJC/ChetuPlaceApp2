package desappmov.chetuplaceapp.Fragmentos;
...
import tools.CreacionesAdapter;
import desappmov.chetuplaceapp.R;
import desappmov.chetuplaceapp.VolleySingleton;
...
public class main extends Fragment {
  ...
  */
     ...
     */
    private CreacionesAdapter adapter;
...
/*
    ...
    private void procesarRespuesta(JSONObject response) {
        try {
            ...
            switch (estado) {
                case "1": // EXITO
                    // Obtener array "creaciones" Json
                    JSONArray mensaje = response.getJSONArray("creaciones");
                    // Parsear con Gson
                    Creaciones[] creaciones = gson.fromJson(mensaje.toString(), Creaciones[].class);
                    // Inicializar adaptador
                    adapter = new CreacionesAdapter(Arrays.asList(creaciones), getActivity());
